...
public class EnterpriseOperations {
    ...
    public Enterprise getEnterprise(long id) {
        ...
        if (cursor != null && cursor.getCount()>=1) {
            cursor.moveToFirst();
             e = new Enterprise(Long.parseLong(cursor.getString(0)), R.drawable.human, cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6));
        } else {
             e=null;
        }
        // return Enterprise
